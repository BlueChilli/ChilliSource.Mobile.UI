...
[assembly: Xamarin.Forms.ExportRenderer(typeof(Xamarin.Forms.NavigationPage), typeof(HackedNavigationRenderer))]

namespace ChilliSource.Mobile.UI.ReactiveUI.iOS
{
    public sealed class HackedNavigationRenderer : NavigationRenderer
    {
