...
namespace ChilliSource.Mobile.UI
{
    public class KeyboardOverlapContentPageRenderer : PageRenderer
    {
        ...
        void OnKeyboardChanged(bool visible, float keyboardHeight)
        {
            ...
            {
                CenterViewInScrollView(activeView, scrollView, keyboardHeight);
            }
        }

        protected virtual void CenterViewInScrollView(UIView viewToCenter, UIScrollView scrollView, float keyboardHeight)
        {
        ...
        //TODO: refactor to UIViewController extension
        UINavigationController GetUINavigationController(UIViewController controller)
        {
            ...
            if (controller.ChildViewControllers.Count() != 0)
            {
                ...
                {
                    Console.WriteLine("local iteration {0}: current controller has {1} children", c, count);
