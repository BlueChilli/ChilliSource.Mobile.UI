...
namespace ChilliSource.Mobile.UI
{
    ...
    public partial class ImageButtonRenderer : ButtonRenderer
    {
        ...
        private async Task SetImageSourceAsync(Android.Widget.Button targetButton, ImageButton model)
        {
            ...
            using (var bitmap = await GetBitmapAsync(source).ConfigureAwait(false))
            {
                ...
                else
                {
                    ...
                    using (var scaledDrawable = GetScaleDrawable(drawable, (int) GetWidth(model.ImageWidthRequest), (int) GetHeight(model.ImageHeightRequest)))
                    {
                        Drawable left = null;
                        Drawable right = null;
                        Drawable top = null;
        ...
        {
            const double DefaultWidth = 50.0;
