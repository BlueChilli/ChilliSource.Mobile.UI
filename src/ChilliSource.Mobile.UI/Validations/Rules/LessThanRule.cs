...
{
    /// <summary>
    /// "Less than" comparison validation rule.
    /// </summary>
    public class LessThanRule<T> : ComparisonRule<T>
    {
        /// <summary>
        ...
        public LessThanRule(Func<T> otherVal, string validationMessage) : base(otherVal, validationMessage)
        {
        }
        ...
        public LessThanRule(Func<T> otherVal, string validationMessage, IComparer<T> comparer) : base(otherVal, validationMessage, comparer)
        {
        }
