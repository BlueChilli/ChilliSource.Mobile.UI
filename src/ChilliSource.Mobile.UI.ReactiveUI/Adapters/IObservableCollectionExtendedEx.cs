...
{
	public static class IObservableCollectionExtendedEx
	{
		internal static void CloneObservableCollectionExtended<T>(this IObservableCollectionExtended<T> source, IChangeSet<T> changes)
		{
