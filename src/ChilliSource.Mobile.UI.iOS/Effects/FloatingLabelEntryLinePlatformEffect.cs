...
[assembly: ExportEffect(typeof(FloatingLabelEntryLinePlatformEffect), "FloatingLabelEntryLineEffect")]

namespace ChilliSource.Mobile.UI
{
	/// <summary>
	/// Platform effect that adds a customizable line to the floating label entry.
	/// </summary>
	public class FloatingLabelEntryLinePlatformEffect : PlatformEffect
	{
		...
		LineEffect.FloatingLabelEntryLineEffect _effect;
		...
		{
			_effect = (LineEffect.FloatingLabelEntryLineEffect)Element.Effects.FirstOrDefault(m => m is LineEffect.FloatingLabelEntryLineEffect);
		...
		{
			_lineColor = LineEffect.GetLineColor(Element);
			_lineHeight = LineEffect.GetLineHeight(Element);
		...
		protected override void OnElementPropertyChanged(System.ComponentModel.PropertyChangedEventArgs args)
		{
			...
			if (args.PropertyName == LineEffect.LineColorProperty.PropertyName || args.PropertyName == LineEffect.LineHeightProperty.PropertyName)
			{
				UpdateLineProperties();
			}
		}
