...
namespace ChilliSource.Mobile.UI
{
	public class ExtendedLabelRenderer : LabelRenderer
	{
		...
		protected override void OnElementPropertyChanged(object sender, PropertyChangedEventArgs e)
		{
				...
				e.PropertyName == ExtendedLabel.ChildrenProperty.PropertyName)
			{
				SetStyle();
					 ...
					 e.PropertyName == ExtendedLabel.SimpleLineBreakModeProperty.PropertyName)
			{
		...
		public ExtendedLabel ExtendedLabel
		{
			get
			{
				return Element as ExtendedLabel;
			}
		}
		...
		void UpdateLineFit()
		{
			...
			if (ExtendedLabel.SimpleLineBreakMode != LineBreakMode.NoWrap)
			{
				switch (ExtendedLabel.SimpleLineBreakMode)
				{
